...
$(document).ready(function () {
    ...
    function fetchCrop(page = 1, search = "") {
        $.ajax({
            url: "data/wateringNeeds/fetch.php",
            type: "GET",
    ...
    $(document).on('click', '#savecropButton' , function(){
        ...
        if (fcropType === '') {
            ...
            $.ajax({
                url: "data/wateringNeeds/add.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
    ...
    $(document).on('click', '#update-btn' , function(){
        ...
        $('#cropForm')[0].reset();   
        $.ajax({
            url: "data/wateringNeeds/getDetails.php", // Endpoint to fetch details
            type: "GET",
            data: { id: id },
            dataType: "json",
            success: function (response) {
                ...
                if (response.success) {
                    ...
                    $("#fcropType").val(response.data.needs);
                } else {
    ...
    $(document).on('click', '#updateCropButton' , function(e){
        ...
        if (fcropType === '') {
            ...
            $.ajax({
                url: "data/wateringNeeds/update.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
    ...
    $(document).on("click", ".delete-btn", function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "data/wateringNeeds/delete.php",
                    type: "POST",
                    data: { id: cropId },
                    dataType: "json",
                    success: function(response) {
