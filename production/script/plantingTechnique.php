...
$(document).ready(function () {
    ...
    function fetchCrop(page = 1, search = "") {
        $.ajax({
            url: "data/plantingTechnique/fetch.php",
            type: "GET",
    ...
    $(document).on('click', '#savecropButton' , function(){
        ...
        if (fcropType === '') {
            ...
            $.ajax({
                url: "data/plantingTechnique/add.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
    ...
    $(document).on('click', '#update-btn' , function(){
        ...
        $('#cropForm')[0].reset();   
        $.ajax({
            url: "data/plantingTechnique/getDetails.php", // Endpoint to fetch details
            type: "GET",
            data: { id: id },
            dataType: "json",
            success: function (response) {
                ...
                if (response.success) {
                    ...
                    $("#fcropType").val(response.data.technique);
                } else {
    ...
    $(document).on('click', '#updateCropButton' , function(e){
        ...
        if (fcropType === '') {
            ...
            $.ajax({
                url: "data/plantingTechnique/update.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
    ...
    $(document).on("click", ".delete-btn", function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "data/plantingTechnique/delete.php",
                    type: "POST",
                    data: { id: cropId },
                    dataType: "json",
                    success: function(response) {
