...
$(document).ready(function () {
    ...
    function fetchCrop(page = 1, search = "") {
        $.ajax({
            url: "data/cropType/fetch_crop.php",
            type: "GET",
    ...
    $(document).on('click', '#savecropButton' , function(){
        ...
        if (fcropType === '') {
            ...
            $.ajax({
                url: "data/cropType/add_crop.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
    ...
    $(document).on('click', '#update-btn' , function(){
        ...
        $('#cropForm')[0].reset();   
        $.ajax({
            url: "data/cropType/getCropDetails.php", // Endpoint to fetch details
            type: "GET",
            data: { id: id },
            dataType: "json",
            success: function (response) {
                ...
                if (response.success) {
                    ...
                    $("#fcropType").val(response.data.type);
                } else {
    ...
    $(document).on('click', '#updateCropButton' , function(e){
        ...
        if (fcropType === '') {
            ...
            $.ajax({
                url: "data/cropType/updatecrop.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
    ...
    $(document).on("click", ".delete-btn", function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "data/cropType/delete_crop.php",
                    type: "POST",
                    data: { id: cropId },
                    dataType: "json",
                    success: function(response) {
                        if (response.status === "success") {
                            Swal.fire(
                                'Deleted!',
                                'Your Crop records has been deleted.',
                                'success'
                            );
